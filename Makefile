...
distdir: FORCE
	...
	$(COPY_FILE) --parents datastructs.h dptdialog.h nmeadata.h mainwindow.h serialportdialog.h aamdialog.h boddialog.h libs/RangeSlider.h threads.h startupdialog.h $(DISTDIR)/
